    ...
    <>
        ...
        <section className="relative overflow-visible">
          <div className="flex  justify-center items-end flex-col md:flex-row relative overflow-visible">
            <div className="flex justify-center  items-center gap-10 relative overflow-visible">
              ...
              <p className="md:text-lg text-base text-justify md:max-w-100 indent-5" data-aos="fade-up">
                The amplifire powers the speaker driver to remove background
                noise works with th H1 chip to control listening levels.
              </p>
            </div>
            <p className="md:text-lg text-base text-justify max-w-100 indent-5 mt-10 md:mt-0" data-aos="fade-up">
          ...
          <div className="md:mt-20 mt-10">
            <p className="md:text-lg text-base  text-justify max-w-100 m-auto indent-5" data-aos="fade-down">
      ...
      <div>
        <section className="mt-20 pb-0">
          <div>
            <p className="md:text-lg text-base  text-justify max-w-100 indent-5" data-aos="fade-in">
          ...
          <div className="md:-mt-58 -mt-10">
            <img
              ...
              data-aos="fade-in"
            />
            <p className="md:text-lg text-base text-justify max-w-100 indent-5 ml-auto mt-3" data-aos="fade-in">
              Powerfull bass is delivered by a custom-built high-excurasion,
              low-distortion speaker driver.
            </p>
          </div>
