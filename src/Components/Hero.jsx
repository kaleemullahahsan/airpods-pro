import heroBg from "/images/tinywow_1_2_4254356 2.png";
function Hero() {
  return (
    <section data-aos="fade-up" className=" h-[80vh] md:h-screen mt-10 bg-size-[200px] md:bg-size-[400px] w-screen bg-center  bg-no-repeat flex justify-center  items-end"
