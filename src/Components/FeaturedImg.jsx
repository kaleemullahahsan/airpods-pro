...
function FeaturedImg() {
  return (
    <section className="flex justify-center items-center flex-col gap-20 my-15 overflow-hidden">
      ...
      <div className="flex justify-center  items-end">
        <img src={`${leftBud}`} alt="" className="md:max-w-100 max-w-20" data-aos="fade-right"/>
        ...
        <img src={`${rightBud}`} alt="" className="md:max-w-100 max-w-20" data-aos="fade-left"/>
      </div>
    </section>
  );
}
